...
\affiliation{California NanoSystems Institute, Los Angeles, California 90095, USA}
\author{Ian K. Blaby}
\affiliation{Department of Chemistry and Biochemistry, University of California, Los Angeles, California 90095. Current address: Biology Department, Brookhaven National Laboratory, Upton, NY, USA}
\author{Allen Huang}
\affiliation{Department of Electrical Engineering, University of California, Los Angeles, California 90095, USA}
...
\begin{figure*}
\includegraphics[scale=0.6]{Figure2DImage.pdf}
...
\bibitem{mahjoubfar2015design}
\bibinfo{author}{Mahjoubfar, A.}, \bibinfo{author}{Chen, C.} \&
  \bibinfo{author}{Jalali, B.}
\newblock \bibinfo{title}{Design of warped stretch transform}.
\newblock \emph{\bibinfo{journal}{Scientific Reports}}
  \textbf{\bibinfo{volume}{5}}, \bibinfo{pages}{17148}
  (\bibinfo{year}{2015}).
...
\newblock \bibinfo{title}{Tag, you’re it! \textit{chlamydomonas} as a reference
...
\newblock \bibinfo{title}{Starchless mutants of \textit{chlamydomonas reinhardtii} lack
...
\newblock \bibinfo{title}{Increased lipid accumulation in the \textit{chlamydomonas
...
\newblock \bibinfo{title}{\textit{Chlamydomonas} starchless mutant defective in
...
\newblock \bibinfo{title}{The path to triacylglyceride obesity in the \textit{sta6}
  strain of \textit{chlamydomonas reinhardtii}}.
