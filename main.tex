...
\begin{figure*}
\includegraphics[scale=0.6]{FigureSetup.jpg}
\caption{\label{fig:Setup} Caption goes here.}
\end{figure*}
...
\begin{figure*}
\includegraphics[scale=0.6]{Figure2DImage.jpg}
\caption{\label{fig:2DImage} Caption goes here.}
\end{figure*}
...
\caption{\label{fig:OTSWScatter} Caption goes here.}
\end{figure*}
...
\caption{\label{fig:Correlation} Caption goes here.}
\end{figure*}
...
\begin{figure*}
\includegraphics[scale=0.6]{FigureFeaturesRank.jpg}
\caption{\label{fig:FeaturesRank} Caption goes here.}
\end{figure*}
...
\begin{figure*}
\includegraphics[scale=0.6]{FigureNeuralNet.jpg}
\caption{\label{fig:NeuralNet} Caption goes here.}
\end{figure*}
...
\caption{\label{fig:OTSWROC} Caption goes here.}
\end{figure*}
...
\begin{figure*}
\includegraphics[scale=0.6]{FigurePCA.jpg}
\caption{\label{fig:PCA} Caption goes here.}
\end{figure*}
