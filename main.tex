...
\bibitem [{\citenamefont {Domingos}(1999)}]{domingos1999role}%
  \BibitemOpen
  \bibfield  {author} {\bibinfo {author} {\bibfnamefont {Pedro}\ \bibnamefont
  {Domingos}},\ }\bibfield  {title} {\enquote {\bibinfo {title} {The role of
  occam's razor in knowledge discovery},}\ }\href@noop {} {\bibfield  {journal}
  {\bibinfo  {journal} {Data mining and knowledge discovery}\ }\textbf
  {\bibinfo {volume} {3}},\ \bibinfo {pages} {409--425} (\bibinfo {year}
  {1999})}\BibitemShut {NoStop}%
