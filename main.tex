...
\caption{\label{fig:Channel} PDMS microfluidic channel mounted on high-reflective surface with near-infrared dielectric coating. The microfluidic device consists of a hydrodynamic focusing region and an imaging region targeted by the interrogation rainbow flashes in TS-QPI system. (a) Sample flow with suspended cells is fed into the channel through sample inlet and deionized water as the sheath flows is sent through sheath inlet. At the hydrodynamic focusing region, the sheath pressure focused the sample at the center of the channel by narrowing its flow width from \SI{200}{\micro\meter} to about \SI{40}{\micro\meter} with a sheath to sample volume ratio of 3:1. (b) The pattern of the mask used to imprint microfluidic channel design on silicon wafer with photoresist.}
\end{figure*}
