...
\begin{tabular}{|p{0.11\textwidth}|p{0.11\textwidth}|p{0.07\textwidth}|p{0.05\textwidth}|p{0.07\textwidth}|p{0.38\textwidth}|p{0.10\textwidth}|}
 \hline
 System catagory   &Component  &Lateral resolution    &Field of View    & OPD resolution  
 &NUmber of resovable points	 &Resolution\\  \hline
\multicolumn{1}{ |p{0.08\textwidth}  }{\multirow{3}{*}{Optical} } &
\multicolumn{1}{ |p{0.11\textwidth}| }{Laser} & &*  & & & \\ \cline{2-7}
\multicolumn{1}{ |p{0.08\textwidth}  }{} &
\multicolumn{1}{ |p{0.11\textwidth}| }{Diffraction gratings} &* &*  & &$N_{grating} = \frac{\Delta\lambda}{\delta\lambda_{grating}} =\Delta\lambda /(\lambda \cdot \frac{d}{m\cdot2w_0})$ & 42\\ \cline{2-7}
\multicolumn{1}{ |p{0.08\textwidth}  }{system}         &
\multicolumn{1}{ |p{0.11\textwidth}| }{Lenses and mirrors} &* &* &* & $N_{Abbe} = \frac{FOV}{\delta x_{diffraction}} =\frac{FOV}{(\frac{\lambda + \Delta \lambda/2}{2 \cdot NA})} $ & 65    \\ \cline{1-7}
\multicolumn{1}{ |p{0.08\textwidth}  }{\multirow{1}{*}{Time Stretch} } &
\multicolumn{1}{ |p{0.11\textwidth}| }{Group Velocity Dispersion} &* & & &$N_{DFT}=\frac{\Delta\lambda}{\delta\lambda}=\frac{\Delta\lambda}{\lambda\cdot\sqrt{\frac{2}{Dz\cdot c}}}$ &179 \\ \cline{1-7}
\multicolumn{1}{ |p{0.08\textwidth}  }{\multirow{3}{*}{Electronic} } &
\multicolumn{1}{ |p{0.11\textwidth}| }{Photodetector Bandwidth} &* & & &$N_{PD}=\frac{\Delta t}{\delta t}=\frac{D\cdot\Delta\lambda}{0.35/B}$ &465 \\ \cline{2-7}
\multicolumn{1}{ |p{0.08\textwidth}  }{back-end} &
\multicolumn{1}{ |p{0.11\textwidth}| }{ADC Sampling Rate} &* & &* &$N_{ADC}=Dz\Delta\lambda f_{ADC}$ &1366 \\ \cline{2-7}
\multicolumn{1}{ |p{0.08\textwidth} }{}       &
\multicolumn{1}{ |p{0.11\textwidth}| }{ENOB} & & &* &$2^{ENOB}$ &$\frac{1}{2}sin(4\pi \Delta L/\lambda)=2^{-n}$ \\ \cline{1-7}
\end{tabular}
\end{table*}
