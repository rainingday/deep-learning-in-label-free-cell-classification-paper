...
%</preamble>
\bibitem [{\citenamefont {Shapiro}(2005)}]{shapiro2005practical}%
  \BibitemOpen
  \bibfield  {author} {\bibinfo {author} {\bibfnamefont {Howard~M}\
  \bibnamefont {Shapiro}},\ }\href@noop {} {\emph {\bibinfo {title} {Practical
  flow cytometry}}}\ (\bibinfo  {publisher} {John Wiley \& Sons},\ \bibinfo
  {year} {2005})\BibitemShut {NoStop}%
\bibitem [{\citenamefont {Watson}(2004)}]{watson2004introduction}%
  \BibitemOpen
  \bibfield  {author} {\bibinfo {author} {\bibfnamefont {James~V}\ \bibnamefont
  {Watson}},\ }\href@noop {} {\emph {\bibinfo {title} {Introduction to flow
  cytometry}}}\ (\bibinfo  {publisher} {Cambridge University Press},\ \bibinfo
  {year} {2004})\BibitemShut {NoStop}%
\bibitem [{\citenamefont {Perfetto}\ \emph {et~al.}(2004)\citenamefont
  {Perfetto}, \citenamefont {Chattopadhyay},\ and\ \citenamefont
  {Roederer}}]{perfetto2004seventeen}%
  \BibitemOpen
  \bibfield  {author} {\bibinfo {author} {\bibfnamefont {Stephen~P}\
  \bibnamefont {Perfetto}}, \bibinfo {author} {\bibfnamefont {Pratip~K}\
  \bibnamefont {Chattopadhyay}}, \ and\ \bibinfo {author} {\bibfnamefont
  {Mario}\ \bibnamefont {Roederer}},\ }\bibfield  {title} {\enquote {\bibinfo
  ...
  Immunology}\ }\textbf {\bibinfo {volume} {4}},\ \bibinfo {pages} {648--655}
  (\bibinfo {year} {2004})}\BibitemShut {NoStop}%
\bibitem [{\citenamefont {Basiji}\ \emph {et~al.}(2007)\citenamefont {Basiji},
  \citenamefont {Ortyn}, \citenamefont {Liang}, \citenamefont {Venkatachalam},\
  and\ \citenamefont {Morrissey}}]{basiji2007cellular}%
  \BibitemOpen
  \bibfield  {author} {\bibinfo {author} {\bibfnamefont {David~A}\ \bibnamefont
  {Basiji}}, \bibinfo {author} {\bibfnamefont {William~E}\ \bibnamefont
  {Ortyn}}, \bibinfo {author} {\bibfnamefont {Luchuan}\ \bibnamefont {Liang}},
  \bibinfo {author} {\bibfnamefont {Vidya}\ \bibnamefont {Venkatachalam}}, \
  and\ \bibinfo {author} {\bibfnamefont {Philip}\ \bibnamefont {Morrissey}},\
  }\bibfield  {title} {\enquote {\bibinfo {title} {Cellular image analysis and
  imaging by flow cytometry},}\ }\href@noop {} {\bibfield  {journal} {\bibinfo
  {journal} {Clinics in laboratory medicine}\ }\textbf {\bibinfo {volume}
  {27}},\ \bibinfo {pages} {653--670} (\bibinfo {year} {2007})}\BibitemShut
  {NoStop}%
\bibitem [{\citenamefont {Basiji}\ and\ \citenamefont
  {Ortyn}(2001)}]{basiji2001imaging}%
  \BibitemOpen
  \bibfield  {author} {\bibinfo {author} {\bibfnamefont {David~A}\ \bibnamefont
  {Basiji}}\ and\ \bibinfo {author} {\bibfnamefont {William~E}\ \bibnamefont
  {Ortyn}},\ }\href@noop {} {\enquote {\bibinfo {title} {Imaging and analyzing
  parameters of small moving objects such as cells},}\ } (\bibinfo {year}
  {2001}),\ \bibinfo {note} {uS Patent 6,249,341}\BibitemShut {NoStop}%
\bibitem [{\citenamefont {Carpenter}\ \emph {et~al.}(2006)\citenamefont
  {Carpenter}, \citenamefont {Jones}, \citenamefont {Lamprecht}, \citenamefont
  {Clarke}, \citenamefont {Kang}, \citenamefont {Friman}, \citenamefont
  {Guertin}, \citenamefont {Chang}, \citenamefont {Lindquist}, \citenamefont
  {Moffat} \emph {et~al.}}]{carpenter2006cellprofiler}%
  \BibitemOpen
  \bibfield  {author} {\bibinfo {author} {\bibfnamefont {Anne~E}\ \bibnamefont
  {Carpenter}}, \bibinfo {author} {\bibfnamefont {Thouis~R}\ \bibnamefont
  {Jones}}, \bibinfo {author} {\bibfnamefont {Michael~R}\ \bibnamefont
  {Lamprecht}}, \bibinfo {author} {\bibfnamefont {Colin}\ \bibnamefont
  {Clarke}}, \bibinfo {author} {\bibfnamefont {In~H}\ \bibnamefont {Kang}},
  \bibinfo {author} {\bibfnamefont {Ola}\ \bibnamefont {Friman}}, \bibinfo
  {author} {\bibfnamefont {David~A}\ \bibnamefont {Guertin}}, \bibinfo {author}
  {\bibfnamefont {Joo~H}\ \bibnamefont {Chang}}, \bibinfo {author}
  {\bibfnamefont {Robert~A}\ \bibnamefont {Lindquist}}, \bibinfo {author}
  {\bibfnamefont {Jason}\ \bibnamefont {Moffat}},  \emph {et~al.},\ }\bibfield
  {title} {\enquote {\bibinfo {title} {Cellprofiler: image analysis software
  for identifying and quantifying cell phenotypes},}\ }\href@noop {} {\bibfield
   {journal} {\bibinfo  {journal} {Genome biology}\ }\textbf {\bibinfo {volume}
  {7}},\ \bibinfo {pages} {R100} (\bibinfo {year} {2006})}\BibitemShut
  {NoStop}%
\bibitem [{\citenamefont {Razavi}(1995)}]{razavi1995principles}%
  \BibitemOpen
  \bibfield  {author} {\bibinfo {author} {\bibfnamefont {Behzad}\ \bibnamefont
  {Razavi}},\ }\href@noop {} {\emph {\bibinfo {title} {Principles of data
  conversion system design}}},\ Vol.\ \bibinfo {volume} {126}\ (\bibinfo
  {publisher} {IEEE press New York},\ \bibinfo {year} {1995})\BibitemShut
  {NoStop}%
\bibitem [{\citenamefont {Mahjoubfar}\ \emph
  {et~al.}(2013{\natexlab{a}})\citenamefont {Mahjoubfar}, \citenamefont {Goda},
  \citenamefont {Betts},\ and\ \citenamefont
  {Jalali}}]{mahjoubfar2013optically}%
  \BibitemOpen
  \bibfield  {author} {\bibinfo {author} {\bibfnamefont {Ata}\ \bibnamefont
  {Mahjoubfar}}, \bibinfo {author} {\bibfnamefont {Keisuke}\ \bibnamefont
  {Goda}}, \bibinfo {author} {\bibfnamefont {Gary}\ \bibnamefont {Betts}}, \
  and\ \bibinfo {author} {\bibfnamefont {Bahram}\ \bibnamefont {Jalali}},\
  }\bibfield  {title} {\enquote {\bibinfo {title} {Optically amplified
  detection for biomedical sensing and imaging},}\ }\href@noop {} {\bibfield
  {journal} {\bibinfo  {journal} {JOSA A}\ }\textbf {\bibinfo {volume} {30}},\
  \bibinfo {pages} {2124--2132} (\bibinfo {year}
  {2013}{\natexlab{a}})}\BibitemShut {NoStop}%
\bibitem [{\citenamefont {Goda}\ \emph {et~al.}(2012)\citenamefont {Goda},
  \citenamefont {Ayazi}, \citenamefont {Gossett}, \citenamefont {Sadasivam},
  \citenamefont {Lonappan}, \citenamefont {Sollier}, \citenamefont {Fard},
  \citenamefont {Hur}, \citenamefont {Adam}, \citenamefont {Murray} \emph
  {et~al.}}]{goda2012high}%
  \BibitemOpen
  \bibfield  {author} {\bibinfo {author} {\bibfnamefont {Keisuke}\ \bibnamefont
  {Goda}}, \bibinfo {author} {\bibfnamefont {Ali}\ \bibnamefont {Ayazi}},
  \bibinfo {author} {\bibfnamefont {Daniel~R}\ \bibnamefont {Gossett}},
  \bibinfo {author} {\bibfnamefont {Jagannath}\ \bibnamefont {Sadasivam}},
  \bibinfo {author} {\bibfnamefont {Cejo~K}\ \bibnamefont {Lonappan}}, \bibinfo
  {author} {\bibfnamefont {Elodie}\ \bibnamefont {Sollier}}, \bibinfo {author}
  {\bibfnamefont {Ali~M}\ \bibnamefont {Fard}}, \bibinfo {author}
  {\bibfnamefont {Soojung~Claire}\ \bibnamefont {Hur}}, \bibinfo {author}
  {\bibfnamefont {Jost}\ \bibnamefont {Adam}}, \bibinfo {author} {\bibfnamefont
  {Coleman}\ \bibnamefont {Murray}},  \emph {et~al.},\ }\bibfield  {title}
  {\enquote {\bibinfo {title} {High-throughput single-microparticle imaging
  flow analyzer},}\ }\href@noop {} {\bibfield  {journal} {\bibinfo  {journal}
  {Proceedings of the National Academy of Sciences}\ }\textbf {\bibinfo
  {volume} {109}},\ \bibinfo {pages} {11630--11635} (\bibinfo {year}
  {2012})}\BibitemShut {NoStop}%
\bibitem [{\citenamefont {Zanella}\ \emph {et~al.}(2010)\citenamefont
  {Zanella}, \citenamefont {Lorens},\ and\ \citenamefont
  {Link}}]{zanella2010high}%
  \BibitemOpen
  \bibfield  {author} {\bibinfo {author} {\bibfnamefont {Fabian}\ \bibnamefont
  {Zanella}}, \bibinfo {author} {\bibfnamefont {James~B}\ \bibnamefont
  {Lorens}}, \ and\ \bibinfo {author} {\bibfnamefont {Wolfgang}\ \bibnamefont
  {Link}},\ }\bibfield  {title} {\enquote {\bibinfo {title} {High content
  screening: seeing is believing},}\ }\href@noop {} {\bibfield  {journal}
  {\bibinfo  {journal} {Trends in biotechnology}\ }\textbf {\bibinfo {volume}
  {28}},\ \bibinfo {pages} {237--245} (\bibinfo {year} {2010})}\BibitemShut
  {NoStop}%
\bibitem [{\citenamefont {Mahjoubfar}\ \emph
  {et~al.}(2013{\natexlab{b}})\citenamefont {Mahjoubfar}, \citenamefont {Chen},
  \citenamefont {Niazi}, \citenamefont {Rabizadeh},\ and\ \citenamefont
  {Jalali}}]{mahjoubfar2013label}%
  \BibitemOpen
  \bibfield  {author} {\bibinfo {author} {\bibfnamefont {Ata}\ \bibnamefont
  {Mahjoubfar}}, \bibinfo {author} {\bibfnamefont {Claire}\ \bibnamefont
  {Chen}}, \bibinfo {author} {\bibfnamefont {Kayvan~R}\ \bibnamefont {Niazi}},
  \bibinfo {author} {\bibfnamefont {Shahrooz}\ \bibnamefont {Rabizadeh}}, \
  and\ \bibinfo {author} {\bibfnamefont {Bahram}\ \bibnamefont {Jalali}},\
  }\bibfield  {title} {\enquote {\bibinfo {title} {Label-free high-throughput
  cell screening in flow},}\ }\href@noop {} {\bibfield  {journal} {\bibinfo
  {journal} {Biomedical optics express}\ }\textbf {\bibinfo {volume} {4}},\
  \bibinfo {pages} {1618--1625} (\bibinfo {year}
  {2013}{\natexlab{b}})}\BibitemShut {NoStop}%
\bibitem [{\citenamefont {Goda}\ and\ \citenamefont
  {Jalali}(2013)}]{goda2013dispersive}%
  \BibitemOpen
  \bibfield  {author} {\bibinfo {author} {\bibfnamefont {K}~\bibnamefont
  {Goda}}\ and\ \bibinfo {author} {\bibfnamefont {B}~\bibnamefont {Jalali}},\
  }\bibfield  {title} {\enquote {\bibinfo {title} {Dispersive fourier
  transformation for fast continuous single-shot measurements},}\ }\href@noop
  {} {\bibfield  {journal} {\bibinfo  {journal} {Nature Photonics}\ }\textbf
  {\bibinfo {volume} {7}},\ \bibinfo {pages} {102--112} (\bibinfo {year}
  {2013})}\BibitemShut {NoStop}%
\bibitem [{\citenamefont {Solli}\ \emph {et~al.}(2009)\citenamefont {Solli},
  \citenamefont {Gupta},\ and\ \citenamefont {Jalali}}]{solli2009optical}%
  \BibitemOpen
  \bibfield  {author} {\bibinfo {author} {\bibfnamefont {DR}~\bibnamefont
  {Solli}}, \bibinfo {author} {\bibfnamefont {S}~\bibnamefont {Gupta}}, \ and\
  \bibinfo {author} {\bibfnamefont {B}~\bibnamefont {Jalali}},\ }\bibfield
  {title} {\enquote {\bibinfo {title} {Optical phase recovery in the dispersive
  fourier transform},}\ }\href@noop {} {\bibfield  {journal} {\bibinfo
  {journal} {Applied Physics Letters}\ }\textbf {\bibinfo {volume} {95}},\
  \bibinfo {pages} {231108} (\bibinfo {year} {2009})}\BibitemShut {NoStop}%
\bibitem [{\citenamefont {Goda}\ \emph
  {et~al.}(2009{\natexlab{a}})\citenamefont {Goda}, \citenamefont {Solli},
  \citenamefont {Tsia},\ and\ \citenamefont {Jalali}}]{goda2009theory}%
  \BibitemOpen
  \bibfield  {author} {\bibinfo {author} {\bibfnamefont {Keisuke}\ \bibnamefont
  {Goda}}, \bibinfo {author} {\bibfnamefont {Daniel~R}\ \bibnamefont {Solli}},
  \bibinfo {author} {\bibfnamefont {Kevin~K}\ \bibnamefont {Tsia}}, \ and\
  \bibinfo {author} {\bibfnamefont {Bahram}\ \bibnamefont {Jalali}},\
  }\bibfield  {title} {\enquote {\bibinfo {title} {Theory of amplified
  dispersive fourier transformation},}\ }\href@noop {} {\bibfield  {journal}
  {\bibinfo  {journal} {Physical Review A}\ }\textbf {\bibinfo {volume} {80}},\
  \bibinfo {pages} {043821} (\bibinfo {year} {2009}{\natexlab{a}})}\BibitemShut
  {NoStop}%
\bibitem [{\citenamefont {Goda}\ \emph
  {et~al.}(2009{\natexlab{b}})\citenamefont {Goda}, \citenamefont {Tsia},\ and\
  \citenamefont {Jalali}}]{goda2009serial}%
  \BibitemOpen
  \bibfield  {author} {\bibinfo {author} {\bibfnamefont {K}~\bibnamefont
  {Goda}}, \bibinfo {author} {\bibfnamefont {KK}~\bibnamefont {Tsia}}, \ and\
  \bibinfo {author} {\bibfnamefont {B}~\bibnamefont {Jalali}},\ }\bibfield
  {title} {\enquote {\bibinfo {title} {Serial time-encoded amplified imaging
  for real-time observation of fast dynamic phenomena},}\ }\href@noop {}
  {\bibfield  {journal} {\bibinfo  {journal} {Nature}\ }\textbf {\bibinfo
  {volume} {458}},\ \bibinfo {pages} {1145--1149} (\bibinfo {year}
  {2009}{\natexlab{b}})}\BibitemShut {NoStop}%
\bibitem [{\citenamefont {Jalali}\ and\ \citenamefont
  {Mahjoubfar}(2015)}]{jalali2015tailoring}%
  \BibitemOpen
  \bibfield  {author} {\bibinfo {author} {\bibfnamefont {B}~\bibnamefont
  {Jalali}}\ and\ \bibinfo {author} {\bibfnamefont {A}~\bibnamefont
  {Mahjoubfar}},\ }\bibfield  {title} {\enquote {\bibinfo {title} {Tailoring
  wideband signals with a photonic hardware accelerator},}\ }\href {\doibase
  10.1109/JPROC.2015.2418538} {\bibfield  {journal} {\bibinfo  {journal}
  {Proceedings of the IEEE}\ }\textbf {\bibinfo {volume} {103}},\ \bibinfo
  {pages} {1071--1086} (\bibinfo {year} {2015})}\BibitemShut {NoStop}%
\bibitem [{\citenamefont {Chen}\ \emph {et~al.}(2015)\citenamefont {Chen},
  \citenamefont {Mahjoubfar},\ and\ \citenamefont {Jalali}}]{chen2015optical}%
  \BibitemOpen
  \bibfield  {author} {\bibinfo {author} {\bibfnamefont {Claire~Lifan}\
  \bibnamefont {Chen}}, \bibinfo {author} {\bibfnamefont {Ata}\ \bibnamefont
  {Mahjoubfar}}, \ and\ \bibinfo {author} {\bibfnamefont {Bahram}\ \bibnamefont
  {Jalali}},\ }\bibfield  {title} {\enquote {\bibinfo {title} {Optical data
  compression in time stretch imaging},}\ }\href@noop {} {\bibfield  {journal}
  {\bibinfo  {journal} {PLoS ONE}\ }\textbf {\bibinfo {volume} {10}},\ \bibinfo
  {pages} {e0125106} (\bibinfo {year} {2015})}\BibitemShut {NoStop}%
\bibitem [{\citenamefont {Mahjoubfar}\ \emph {et~al.}(2014)\citenamefont
  {Mahjoubfar}, \citenamefont {Chen}, \citenamefont {Niazi}, \citenamefont
  {Rabizadeh},\ and\ \citenamefont {Jalali}}]{mahjoubfar2014label}%
  \BibitemOpen
  \bibfield  {author} {\bibinfo {author} {\bibfnamefont {A}~\bibnamefont
  {Mahjoubfar}}, \bibinfo {author} {\bibfnamefont {C}~\bibnamefont {Chen}},
  \bibinfo {author} {\bibfnamefont {KR}~\bibnamefont {Niazi}}, \bibinfo
  {author} {\bibfnamefont {S}~\bibnamefont {Rabizadeh}}, \ and\ \bibinfo
  {author} {\bibfnamefont {B}~\bibnamefont {Jalali}},\ }\bibfield  {title}
  {\enquote {\bibinfo {title} {Label-free high-throughput imaging flow
  cytometry},}\ }in\ \href@noop {} {\emph {\bibinfo {booktitle} {SPIE LASE}}}\
  (\bibinfo {organization} {International Society for Optics and Photonics},\
  \bibinfo {year} {2014})\ pp.\ \bibinfo {pages} {89720F--89720F}\BibitemShut
  {NoStop}%
\bibitem [{\citenamefont {Gires}\ \emph {et~al.}(2009)\citenamefont {Gires},
  \citenamefont {Klein},\ and\ \citenamefont {Baeuerle}}]{gires2009abundance}%
  \BibitemOpen
  \bibfield  {author} {\bibinfo {author} {\bibfnamefont {Olivier}\ \bibnamefont
  {Gires}}, \bibinfo {author} {\bibfnamefont {Christoph~A}\ \bibnamefont
  {Klein}}, \ and\ \bibinfo {author} {\bibfnamefont {Patrick~A}\ \bibnamefont
  {Baeuerle}},\ }\bibfield  {title} {\enquote {\bibinfo {title} {On the
  abundance of epcam on cancer stem cells},}\ }\href@noop {} {\bibfield
  {journal} {\bibinfo  {journal} {Nature Reviews Cancer}\ }\textbf {\bibinfo
  {volume} {9}},\ \bibinfo {pages} {143--143} (\bibinfo {year}
  {2009})}\BibitemShut {NoStop}%
\bibitem [{\citenamefont {Kling}(2012)}]{kling2012beyond}%
  \BibitemOpen
  \bibfield  {author} {\bibinfo {author} {\bibfnamefont {Jim}\ \bibnamefont
  {Kling}},\ }\bibfield  {title} {\enquote {\bibinfo {title} {Beyond counting
  tumor cells},}\ }\href@noop {} {\bibfield  {journal} {\bibinfo  {journal}
  {Nature biotechnology}\ }\textbf {\bibinfo {volume} {30}},\ \bibinfo {pages}
  {578--580} (\bibinfo {year} {2012})}\BibitemShut {NoStop}%
\bibitem [{\citenamefont {Boddington}\ \emph {et~al.}(2011)\citenamefont
  {Boddington}, \citenamefont {Sutton}, \citenamefont {Henning}, \citenamefont
  {Nedopil}, \citenamefont {Sennino}, \citenamefont {Kim},\ and\ \citenamefont
  {Daldrup-Link}}]{boddington2011labeling}%
  \BibitemOpen
  \bibfield  {author} {\bibinfo {author} {\bibfnamefont {Sophie~E}\
  \bibnamefont {Boddington}}, \bibinfo {author} {\bibfnamefont {Elizabeth~J}\
  \bibnamefont {Sutton}}, \bibinfo {author} {\bibfnamefont {Tobias~D}\
  \bibnamefont {Henning}}, \bibinfo {author} {\bibfnamefont {Alexander~J}\
  \bibnamefont {Nedopil}}, \bibinfo {author} {\bibfnamefont {Barbara}\
  \bibnamefont {Sennino}}, \bibinfo {author} {\bibfnamefont {Anne}\
  \bibnamefont {Kim}}, \ and\ \bibinfo {author} {\bibfnamefont {Heike~E}\
  \bibnamefont {Daldrup-Link}},\ }\bibfield  {title} {\enquote {\bibinfo
  {title} {Labeling human mesenchymal stem cells with fluorescent contrast
  agents: the biological impact},}\ }\href@noop {} {\bibfield  {journal}
  {\bibinfo  {journal} {Molecular Imaging and Biology}\ }\textbf {\bibinfo
  {volume} {13}},\ \bibinfo {pages} {3--9} (\bibinfo {year}
  {2011})}\BibitemShut {NoStop}%
\bibitem [{\citenamefont {Ikeda}\ \emph {et~al.}(2005)\citenamefont {Ikeda},
  \citenamefont {Popescu}, \citenamefont {Dasari},\ and\ \citenamefont
  {Feld}}]{ikeda2005hilbert}%
  \BibitemOpen
  \bibfield  {author} {\bibinfo {author} {\bibfnamefont {Takahiro}\
  \bibnamefont {Ikeda}}, \bibinfo {author} {\bibfnamefont {Gabriel}\
  \bibnamefont {Popescu}}, \bibinfo {author} {\bibfnamefont {Ramachandra~R}\
  \bibnamefont {Dasari}}, \ and\ \bibinfo {author} {\bibfnamefont {Michael~S}\
  \bibnamefont {Feld}},\ }\bibfield  {title} {\enquote {\bibinfo {title}
  {Hilbert phase microscopy for investigating fast dynamics in transparent
  systems},}\ }\href@noop {} {\bibfield  {journal} {\bibinfo  {journal} {Optics
  letters}\ }\textbf {\bibinfo {volume} {30}},\ \bibinfo {pages} {1165--1167}
  (\bibinfo {year} {2005})}\BibitemShut {NoStop}%
\bibitem [{\citenamefont {Popescu}(2011)}]{popescu2011quantitative}%
  \BibitemOpen
  \bibfield  {author} {\bibinfo {author} {\bibfnamefont {Gabriel}\ \bibnamefont
  {Popescu}},\ }\href@noop {} {\emph {\bibinfo {title} {Quantitative phase
  imaging of cells and tissues}}}\ (\bibinfo  {publisher} {McGraw Hill
  Professional},\ \bibinfo {year} {2011})\BibitemShut {NoStop}%
\bibitem [{\citenamefont {Pham}\ \emph {et~al.}(2013)\citenamefont {Pham},
  \citenamefont {Bhaduri}, \citenamefont {Tangella}, \citenamefont
  {Best-Popescu},\ and\ \citenamefont {Popescu}}]{pham2013real}%
  \BibitemOpen
  \bibfield  {author} {\bibinfo {author} {\bibfnamefont {Hoa~V}\ \bibnamefont
  {Pham}}, \bibinfo {author} {\bibfnamefont {Basanta}\ \bibnamefont {Bhaduri}},
  \bibinfo {author} {\bibfnamefont {Krishnarao}\ \bibnamefont {Tangella}},
  \bibinfo {author} {\bibfnamefont {Catherine}\ \bibnamefont {Best-Popescu}}, \
  and\ \bibinfo {author} {\bibfnamefont {Gabriel}\ \bibnamefont {Popescu}},\
  }\bibfield  {title} {\enquote {\bibinfo {title} {Real time blood testing
  using quantitative phase imaging},}\ }\href@noop {} {\bibfield  {journal}
  {\bibinfo  {journal} {PloS one}\ }\textbf {\bibinfo {volume} {8}},\ \bibinfo
  {pages} {e55676} (\bibinfo {year} {2013})}\BibitemShut {NoStop}%
\bibitem [{\citenamefont {Feinerman}\ \emph {et~al.}(2008)\citenamefont
  {Feinerman}, \citenamefont {Veiga}, \citenamefont {Dorfman}, \citenamefont
  {Germain},\ and\ \citenamefont {Altan-Bonnet}}]{feinerman2008variability}%
  \BibitemOpen
  \bibfield  {author} {\bibinfo {author} {\bibfnamefont {Ofer}\ \bibnamefont
  {Feinerman}}, \bibinfo {author} {\bibfnamefont {Jo{\"e}l}\ \bibnamefont
  {Veiga}}, \bibinfo {author} {\bibfnamefont {Jeffrey~R}\ \bibnamefont
  {Dorfman}}, \bibinfo {author} {\bibfnamefont {Ronald~N}\ \bibnamefont
  {Germain}}, \ and\ \bibinfo {author} {\bibfnamefont {Gr{\'e}goire}\
  \bibnamefont {Altan-Bonnet}},\ }\bibfield  {title} {\enquote {\bibinfo
  {title} {Variability and robustness in t cell activation from regulated
  heterogeneity in protein levels},}\ }\href@noop {} {\bibfield  {journal}
  {\bibinfo  {journal} {Science}\ }\textbf {\bibinfo {volume} {321}},\ \bibinfo
  {pages} {1081--1084} (\bibinfo {year} {2008})}\BibitemShut {NoStop}%
\bibitem [{\citenamefont {Sigal}\ \emph {et~al.}(2006)\citenamefont {Sigal},
  \citenamefont {Milo}, \citenamefont {Cohen}, \citenamefont {Geva-Zatorsky},
  \citenamefont {Klein}, \citenamefont {Liron}, \citenamefont {Rosenfeld},
  \citenamefont {Danon}, \citenamefont {Perzov},\ and\ \citenamefont
  {Alon}}]{sigal2006variability}%
  \BibitemOpen
  \bibfield  {author} {\bibinfo {author} {\bibfnamefont {Alex}\ \bibnamefont
  {Sigal}}, \bibinfo {author} {\bibfnamefont {Ron}\ \bibnamefont {Milo}},
  \bibinfo {author} {\bibfnamefont {Ariel}\ \bibnamefont {Cohen}}, \bibinfo
  {author} {\bibfnamefont {Naama}\ \bibnamefont {Geva-Zatorsky}}, \bibinfo
  {author} {\bibfnamefont {Yael}\ \bibnamefont {Klein}}, \bibinfo {author}
  {\bibfnamefont {Yuvalal}\ \bibnamefont {Liron}}, \bibinfo {author}
  {\bibfnamefont {Nitzan}\ \bibnamefont {Rosenfeld}}, \bibinfo {author}
  {\bibfnamefont {Tamar}\ \bibnamefont {Danon}}, \bibinfo {author}
  {\bibfnamefont {Natalie}\ \bibnamefont {Perzov}}, \ and\ \bibinfo {author}
  {\bibfnamefont {Uri}\ \bibnamefont {Alon}},\ }\bibfield  {title} {\enquote
  {\bibinfo {title} {Variability and memory of protein levels in human
  cells},}\ }\href@noop {} {\bibfield  {journal} {\bibinfo  {journal} {Nature}\
  }\textbf {\bibinfo {volume} {444}},\ \bibinfo {pages} {643--646} (\bibinfo
  {year} {2006})}\BibitemShut {NoStop}%
\bibitem [{\citenamefont {Friebel}\ \emph {et~al.}(1999)\citenamefont
  {Friebel}, \citenamefont {Do}, \citenamefont {Hahn}, \citenamefont {Mu} \emph
  {et~al.}}]{friebel1999optical}%
  \BibitemOpen
  \bibfield  {author} {\bibinfo {author} {\bibfnamefont {Moritz}\ \bibnamefont
  {Friebel}}, \bibinfo {author} {\bibfnamefont {Klaus}\ \bibnamefont {Do}},
  \bibinfo {author} {\bibfnamefont {Andreas}\ \bibnamefont {Hahn}}, \bibinfo
  {author} {\bibfnamefont {Gerhard}\ \bibnamefont {Mu}},  \emph {et~al.},\
  }\bibfield  {title} {\enquote {\bibinfo {title} {Optical properties of
  circulating human blood in the wavelength range 400--2500 nm},}\ }\href@noop
  {} {\bibfield  {journal} {\bibinfo  {journal} {Journal of biomedical optics}\
  }\textbf {\bibinfo {volume} {4}},\ \bibinfo {pages} {36--46} (\bibinfo {year}
  {1999})}\BibitemShut {NoStop}%
\bibitem [{\citenamefont {Vona}\ \emph {et~al.}(2000)\citenamefont {Vona},
  \citenamefont {Sabile}, \citenamefont {Louha}, \citenamefont {Sitruk},
  \citenamefont {Romana}, \citenamefont {Sch{\"u}tze}, \citenamefont {Capron},
  \citenamefont {Franco}, \citenamefont {Pazzagli}, \citenamefont {Vekemans}
  \emph {et~al.}}]{vona2000isolation}%
  \BibitemOpen
  \bibfield  {author} {\bibinfo {author} {\bibfnamefont {Giovanna}\
  \bibnamefont {Vona}}, \bibinfo {author} {\bibfnamefont {Abdelmajid}\
  \bibnamefont {Sabile}}, \bibinfo {author} {\bibfnamefont {Malek}\
  \bibnamefont {Louha}}, \bibinfo {author} {\bibfnamefont {Veronique}\
  \bibnamefont {Sitruk}}, \bibinfo {author} {\bibfnamefont {Serge}\
  \bibnamefont {Romana}}, \bibinfo {author} {\bibfnamefont {Karin}\
  \bibnamefont {Sch{\"u}tze}}, \bibinfo {author} {\bibfnamefont
  {Fr{\'e}d{\'e}rique}\ \bibnamefont {Capron}}, \bibinfo {author}
  {\bibfnamefont {Dominique}\ \bibnamefont {Franco}}, \bibinfo {author}
  {\bibfnamefont {Mario}\ \bibnamefont {Pazzagli}}, \bibinfo {author}
  {\bibfnamefont {Michel}\ \bibnamefont {Vekemans}},  \emph {et~al.},\
  }\bibfield  {title} {\enquote {\bibinfo {title} {Isolation by size of
  epithelial tumor cells: a new method for the immunomorphological and
  molecular characterization of circulating tumor cells},}\ }\href@noop {}
  {\bibfield  {journal} {\bibinfo  {journal} {The American journal of
  pathology}\ }\textbf {\bibinfo {volume} {156}},\ \bibinfo {pages} {57--63}
  (\bibinfo {year} {2000})}\BibitemShut {NoStop}%
\bibitem [{\citenamefont {Spencer}\ \emph {et~al.}(2009)\citenamefont
  {Spencer}, \citenamefont {Gaudet}, \citenamefont {Albeck}, \citenamefont
  {Burke},\ and\ \citenamefont {Sorger}}]{spencer2009non}%
  \BibitemOpen
  \bibfield  {author} {\bibinfo {author} {\bibfnamefont {Sabrina~L}\
  \bibnamefont {Spencer}}, \bibinfo {author} {\bibfnamefont {Suzanne}\
  \bibnamefont {Gaudet}}, \bibinfo {author} {\bibfnamefont {John~G}\
  \bibnamefont {Albeck}}, \bibinfo {author} {\bibfnamefont {John~M}\
  \bibnamefont {Burke}}, \ and\ \bibinfo {author} {\bibfnamefont {Peter~K}\
  \bibnamefont {Sorger}},\ }\bibfield  {title} {\enquote {\bibinfo {title}
  {Non-genetic origins of cell-to-cell variability in trail-induced
  apoptosis},}\ }\href@noop {} {\bibfield  {journal} {\bibinfo  {journal}
  {Nature}\ }\textbf {\bibinfo {volume} {459}},\ \bibinfo {pages} {428--432}
...
\bibitem [{\citenamefont {King}(2009)}]{king2009hilbert}%
  \BibitemOpen
  \bibfield  {author} {\bibinfo {author} {\bibfnamefont {Frederick~W}\
  \bibnamefont {King}},\ }\href@noop {} {\emph {\bibinfo {title} {Hilbert
  transforms}}},\ Vol.~\bibinfo {volume} {2}\ (\bibinfo  {publisher} {Cambridge
  University Press Cambridge, UK},\ \bibinfo {year} {2009})\BibitemShut
  {NoStop}%
\bibitem [{\citenamefont {Driscoll}\ \emph {et~al.}(2012)\citenamefont
  {Driscoll}, \citenamefont {Albanese}, \citenamefont {Xiong}, \citenamefont
  {Mailman}, \citenamefont {Losert},\ and\ \citenamefont
  {Cao}}]{driscoll2012automated}%
  \BibitemOpen
  \bibfield  {author} {\bibinfo {author} {\bibfnamefont {Meghan~K}\
  \bibnamefont {Driscoll}}, \bibinfo {author} {\bibfnamefont {Jason~L}\
  \bibnamefont {Albanese}}, \bibinfo {author} {\bibfnamefont {Zheng-Mei}\
  \bibnamefont {Xiong}}, \bibinfo {author} {\bibfnamefont {Mitch}\ \bibnamefont
  {Mailman}}, \bibinfo {author} {\bibfnamefont {Wolfgang}\ \bibnamefont
  {Losert}}, \ and\ \bibinfo {author} {\bibfnamefont {Kan}\ \bibnamefont
  {Cao}},\ }\bibfield  {title} {\enquote {\bibinfo {title} {Automated image
  analysis of nuclear shape: What can we learn from a prematurely aged cell?}}\
  }\href@noop {} {\bibfield  {journal} {\bibinfo  {journal} {Aging (Albany
  NY)}\ }\textbf {\bibinfo {volume} {4}},\ \bibinfo {pages} {119} (\bibinfo
  {year} {2012})}\BibitemShut {NoStop}%
\bibitem [{\citenamefont {Barer}\ \emph {et~al.}(1953)\citenamefont {Barer},
  \citenamefont {Ross},\ and\ \citenamefont
  {Tkaczyk}}]{barer1953refractometry}%
  \BibitemOpen
  \bibfield  {author} {\bibinfo {author} {\bibfnamefont {R}~\bibnamefont
  {Barer}}, \bibinfo {author} {\bibfnamefont {KF}~\bibnamefont {Ross}}, \ and\
  \bibinfo {author} {\bibfnamefont {S}~\bibnamefont {Tkaczyk}},\ }\bibfield
  {title} {\enquote {\bibinfo {title} {Refractometry of living cells.}}\
  }\href@noop {} {\bibfield  {journal} {\bibinfo  {journal} {Nature}\ }\textbf
  {\bibinfo {volume} {171}},\ \bibinfo {pages} {720} (\bibinfo {year}
  {1953})}\BibitemShut {NoStop}%
\bibitem [{\citenamefont {Revel}\ \emph {et~al.}(1974)\citenamefont {Revel},
  \citenamefont {Hoch},\ and\ \citenamefont {Ho}}]{revel1974adhesion}%
  \BibitemOpen
  \bibfield  {author} {\bibinfo {author} {\bibfnamefont {JP}~\bibnamefont
  {Revel}}, \bibinfo {author} {\bibfnamefont {Pamela}\ \bibnamefont {Hoch}}, \
  and\ \bibinfo {author} {\bibfnamefont {D}~\bibnamefont {Ho}},\ }\bibfield
  {title} {\enquote {\bibinfo {title} {Adhesion of culture cells to their
  substratum},}\ }\href@noop {} {\bibfield  {journal} {\bibinfo  {journal}
  {Experimental cell research}\ }\textbf {\bibinfo {volume} {84}},\ \bibinfo
  {pages} {207--218} (\bibinfo {year} {1974})}\BibitemShut {NoStop}%
\bibitem [{\citenamefont {Whur}\ \emph {et~al.}(1977)\citenamefont {Whur},
  \citenamefont {Koppel}, \citenamefont {Urquhart},\ and\ \citenamefont
  {Williams}}]{whur1977substrate}%
  \BibitemOpen
  \bibfield  {author} {\bibinfo {author} {\bibfnamefont {P}~\bibnamefont
  {Whur}}, \bibinfo {author} {\bibfnamefont {H}~\bibnamefont {Koppel}},
  \bibinfo {author} {\bibfnamefont {CM}~\bibnamefont {Urquhart}}, \ and\
  \bibinfo {author} {\bibfnamefont {DC}~\bibnamefont {Williams}},\ }\bibfield
  {title} {\enquote {\bibinfo {title} {Substrate retention of fractured
  retraction fibres during detachment of trypsinized bhk21 fibroblasts},}\
  }\href@noop {} {\bibfield  {journal} {\bibinfo  {journal} {Journal of cell
  science}\ }\textbf {\bibinfo {volume} {24}},\ \bibinfo {pages} {265--273}
  (\bibinfo {year} {1977})}\BibitemShut {NoStop}%
\bibitem [{\citenamefont {Spadinger}\ \emph {et~al.}(1990)\citenamefont
  {Spadinger}, \citenamefont {Poon},\ and\ \citenamefont
  {Palcic}}]{spadinger1990effect}%
  \BibitemOpen
  \bibfield  {author} {\bibinfo {author} {\bibfnamefont {Ingrid}\ \bibnamefont
  {Spadinger}}, \bibinfo {author} {\bibfnamefont {Steven~SS}\ \bibnamefont
  {Poon}}, \ and\ \bibinfo {author} {\bibfnamefont {Branko}\ \bibnamefont
  {Palcic}},\ }\bibfield  {title} {\enquote {\bibinfo {title} {Effect of focus
  on cell detection and recognition by the cell analyzer},}\ }\href@noop {}
  {\bibfield  {journal} {\bibinfo  {journal} {Cytometry}\ }\textbf {\bibinfo
  {volume} {11}},\ \bibinfo {pages} {460--467} (\bibinfo {year}
  {1990})}\BibitemShut {NoStop}%
\bibitem [{\citenamefont {Adams}\ \emph {et~al.}(2008)\citenamefont {Adams},
  \citenamefont {Okagbare}, \citenamefont {Feng}, \citenamefont {Hupert},
  \citenamefont {Patterson}, \citenamefont {Göttert}, \citenamefont
  {McCarley}, \citenamefont {Nikitopoulos}, \citenamefont {Murphy},\ and\
  \citenamefont {Soper}}]{adams2008highly}%
  \BibitemOpen
  \bibfield  {author} {\bibinfo {author} {\bibfnamefont {Andr{\'e}~A}\
  \bibnamefont {Adams}}, \bibinfo {author} {\bibfnamefont {Paul~I}\
  \bibnamefont {Okagbare}}, \bibinfo {author} {\bibfnamefont {Juan}\
  \bibnamefont {Feng}}, \bibinfo {author} {\bibfnamefont {Matuesz~L}\
  \bibnamefont {Hupert}}, \bibinfo {author} {\bibfnamefont {Don}\ \bibnamefont
  {Patterson}}, \bibinfo {author} {\bibfnamefont {Jost}\ \bibnamefont
  {Göttert}}, \bibinfo {author} {\bibfnamefont {Robin~L}\ \bibnamefont
  {McCarley}}, \bibinfo {author} {\bibfnamefont {Dimitris}\ \bibnamefont
  {Nikitopoulos}}, \bibinfo {author} {\bibfnamefont {Michael~C}\ \bibnamefont
  {Murphy}}, \ and\ \bibinfo {author} {\bibfnamefont {Steven~A}\ \bibnamefont
  {Soper}},\ }\bibfield  {title} {\enquote {\bibinfo {title} {Highly efficient
  circulating tumor cell isolation from whole blood and label-free enumeration
  using polymer-based microfluidics with an integrated conductivity sensor},}\
  }\href@noop {} {\bibfield  {journal} {\bibinfo  {journal} {Journal of the
  American Chemical Society}\ }\textbf {\bibinfo {volume} {130}},\ \bibinfo
  {pages} {8633--8641} (\bibinfo {year} {2008})}\BibitemShut {NoStop}%
\bibitem [{\citenamefont {Nagrath}\ \emph {et~al.}(2007)\citenamefont
  {Nagrath}, \citenamefont {Sequist}, \citenamefont {Maheswaran}, \citenamefont
  {Bell}, \citenamefont {Irimia}, \citenamefont {Ulkus}, \citenamefont {Smith},
  \citenamefont {Kwak}, \citenamefont {Digumarthy}, \citenamefont {Muzikansky}
  \emph {et~al.}}]{nagrath2007isolation}%
  \BibitemOpen
  \bibfield  {author} {\bibinfo {author} {\bibfnamefont {Sunitha}\ \bibnamefont
  {Nagrath}}, \bibinfo {author} {\bibfnamefont {Lecia~V}\ \bibnamefont
  {Sequist}}, \bibinfo {author} {\bibfnamefont {Shyamala}\ \bibnamefont
  {Maheswaran}}, \bibinfo {author} {\bibfnamefont {Daphne~W}\ \bibnamefont
  {Bell}}, \bibinfo {author} {\bibfnamefont {Daniel}\ \bibnamefont {Irimia}},
  \bibinfo {author} {\bibfnamefont {Lindsey}\ \bibnamefont {Ulkus}}, \bibinfo
  {author} {\bibfnamefont {Matthew~R}\ \bibnamefont {Smith}}, \bibinfo {author}
  {\bibfnamefont {Eunice~L}\ \bibnamefont {Kwak}}, \bibinfo {author}
  {\bibfnamefont {Subba}\ \bibnamefont {Digumarthy}}, \bibinfo {author}
  {\bibfnamefont {Alona}\ \bibnamefont {Muzikansky}},  \emph {et~al.},\
  }\bibfield  {title} {\enquote {\bibinfo {title} {Isolation of rare
  circulating tumour cells in cancer patients by microchip technology},}\
  }\href@noop {} {\bibfield  {journal} {\bibinfo  {journal} {Nature}\ }\textbf
  {\bibinfo {volume} {450}},\ \bibinfo {pages} {1235--1239} (\bibinfo {year}
  {2007})}\BibitemShut {NoStop}%
\bibitem [{\citenamefont {Gossett}\ \emph {et~al.}(2010)\citenamefont
  {Gossett}, \citenamefont {Weaver}, \citenamefont {Mach}, \citenamefont {Hur},
  \citenamefont {Tse}, \citenamefont {Lee}, \citenamefont {Amini},\ and\
  \citenamefont {Di~Carlo}}]{gossett2010label}%
  \BibitemOpen
  \bibfield  {author} {\bibinfo {author} {\bibfnamefont {Daniel~R}\
  \bibnamefont {Gossett}}, \bibinfo {author} {\bibfnamefont {Westbrook~M}\
  \bibnamefont {Weaver}}, \bibinfo {author} {\bibfnamefont {Albert~J}\
  \bibnamefont {Mach}}, \bibinfo {author} {\bibfnamefont {Soojung~Claire}\
  \bibnamefont {Hur}}, \bibinfo {author} {\bibfnamefont {Henry Tat~Kwong}\
  \bibnamefont {Tse}}, \bibinfo {author} {\bibfnamefont {Wonhee}\ \bibnamefont
  {Lee}}, \bibinfo {author} {\bibfnamefont {Hamed}\ \bibnamefont {Amini}}, \
  and\ \bibinfo {author} {\bibfnamefont {Dino}\ \bibnamefont {Di~Carlo}},\
  }\bibfield  {title} {\enquote {\bibinfo {title} {Label-free cell separation
  and sorting in microfluidic systems},}\ }\href@noop {} {\bibfield  {journal}
  {\bibinfo  {journal} {Analytical and bioanalytical chemistry}\ }\textbf
  {\bibinfo {volume} {397}},\ \bibinfo {pages} {3249--3267} (\bibinfo {year}
  {2010})}\BibitemShut {NoStop}%
\bibitem [{\citenamefont {K{\ae}rn}\ \emph {et~al.}(2005)\citenamefont
  {K{\ae}rn}, \citenamefont {Elston}, \citenamefont {Blake},\ and\
  \citenamefont {Collins}}]{kaern2005stochasticity}%
  \BibitemOpen
  \bibfield  {author} {\bibinfo {author} {\bibfnamefont {Mads}\ \bibnamefont
  {K{\ae}rn}}, \bibinfo {author} {\bibfnamefont {Timothy~C}\ \bibnamefont
  {Elston}}, \bibinfo {author} {\bibfnamefont {William~J}\ \bibnamefont
  {Blake}}, \ and\ \bibinfo {author} {\bibfnamefont {James~J}\ \bibnamefont
  {Collins}},\ }\bibfield  {title} {\enquote {\bibinfo {title} {Stochasticity
  in gene expression: from theories to phenotypes},}\ }\href@noop {} {\bibfield
   {journal} {\bibinfo  {journal} {Nature Reviews Genetics}\ }\textbf {\bibinfo
  {volume} {6}},\ \bibinfo {pages} {451--464} (\bibinfo {year}
  {2005})}\BibitemShut {NoStop}%
\bibitem [{\citenamefont {Maheshri}\ and\ \citenamefont
  {O'Shea}(2007)}]{maheshri2007living}%
  \BibitemOpen
  \bibfield  {author} {\bibinfo {author} {\bibfnamefont {Narendra}\
  \bibnamefont {Maheshri}}\ and\ \bibinfo {author} {\bibfnamefont {Erin~K}\
  \bibnamefont {O'Shea}},\ }\bibfield  {title} {\enquote {\bibinfo {title}
  {Living with noisy genes: how cells function reliably with inherent
  variability in gene expression},}\ }\href@noop {} {\bibfield  {journal}
  {\bibinfo  {journal} {Annu. Rev. Biophys. Biomol. Struct.}\ }\textbf
  {\bibinfo {volume} {36}},\ \bibinfo {pages} {413--434} (\bibinfo {year}
  {2007})}\BibitemShut {NoStop}%
\bibitem [{\citenamefont {Zangle}\ \emph {et~al.}(2014)\citenamefont {Zangle},
  \citenamefont {Teitell},\ and\ \citenamefont {Reed}}]{zangle2014live}%
  \BibitemOpen
  \bibfield  {author} {\bibinfo {author} {\bibfnamefont {Thomas~A}\
  \bibnamefont {Zangle}}, \bibinfo {author} {\bibfnamefont {Michael~A}\
  \bibnamefont {Teitell}}, \ and\ \bibinfo {author} {\bibfnamefont {Jason}\
  \bibnamefont {Reed}},\ }\bibfield  {title} {\enquote {\bibinfo {title} {Live
  cell interferometry quantifies dynamics of biomass partitioning during
  cytokinesis},}\ }\href@noop {} {\bibfield  {journal} {\bibinfo  {journal}
  {PloS one}\ }\textbf {\bibinfo {volume} {9}},\ \bibinfo {pages} {e115726}
  (\bibinfo {year} {2014})}\BibitemShut {NoStop}%
\bibitem [{\citenamefont {Johnston}\ \emph {et~al.}(2012)\citenamefont
  {Johnston}, \citenamefont {Gaal}, \citenamefont {das Neves}, \citenamefont
  {Enver}, \citenamefont {Iborra},\ and\ \citenamefont
  {Jones}}]{johnston2012mitochondrial}%
  \BibitemOpen
  \bibfield  {author} {\bibinfo {author} {\bibfnamefont {Iain~G}\ \bibnamefont
  {Johnston}}, \bibinfo {author} {\bibfnamefont {Bernadett}\ \bibnamefont
  {Gaal}}, \bibinfo {author} {\bibfnamefont {Ricardo~Pires}\ \bibnamefont {das
  Neves}}, \bibinfo {author} {\bibfnamefont {Tariq}\ \bibnamefont {Enver}},
  \bibinfo {author} {\bibfnamefont {Francisco~J}\ \bibnamefont {Iborra}}, \
  and\ \bibinfo {author} {\bibfnamefont {Nick~S}\ \bibnamefont {Jones}},\
  }\bibfield  {title} {\enquote {\bibinfo {title} {Mitochondrial variability as
  a source of extrinsic cellular noise},}\ }\href@noop {} {\bibfield  {journal}
  {\bibinfo  {journal} {PLoS computational biology}\ }\textbf {\bibinfo
  {volume} {8}},\ \bibinfo {pages} {e1002416} (\bibinfo {year}
  {2012})}\BibitemShut {NoStop}%
\bibitem [{\citenamefont {Abu-Mostafa}\ \emph {et~al.}(2012)\citenamefont
  {Abu-Mostafa}, \citenamefont {Magdon-Ismail},\ and\ \citenamefont
  {Lin}}]{abu2012learning}%
  \BibitemOpen
  \bibfield  {author} {\bibinfo {author} {\bibfnamefont {Yaser~S}\ \bibnamefont
  {Abu-Mostafa}}, \bibinfo {author} {\bibfnamefont {Malik}\ \bibnamefont
  {Magdon-Ismail}}, \ and\ \bibinfo {author} {\bibfnamefont {Hsuan-Tien}\
  \bibnamefont {Lin}},\ }\href@noop {} {\emph {\bibinfo {title} {Learning from
  data}}}\ (\bibinfo  {publisher} {AMLBook},\ \bibinfo {year}
  {2012})\BibitemShut {NoStop}%
\bibitem [{\citenamefont {Bishop}\ \emph {et~al.}(2006)\citenamefont {Bishop}
  \emph {et~al.}}]{bishop2006pattern}%
  \BibitemOpen
  \bibfield  {author} {\bibinfo {author} {\bibfnamefont {Christopher~M}\
  \bibnamefont {Bishop}} \emph {et~al.},\ }\href@noop {} {\emph {\bibinfo
  {title} {Pattern recognition and machine learning}}},\ Vol.~\bibinfo {volume}
  {4}\ (\bibinfo  {publisher} {springer New York},\ \bibinfo {year}
  {2006})\BibitemShut {NoStop}%
\bibitem [{\citenamefont {Boddy}\ \emph {et~al.}(1994)\citenamefont {Boddy},
  \citenamefont {Morris}, \citenamefont {Wilkins}, \citenamefont {Tarran},\
  and\ \citenamefont {Burkill}}]{boddy1994neural}%
  \BibitemOpen
  \bibfield  {author} {\bibinfo {author} {\bibfnamefont {Lynne}\ \bibnamefont
  {Boddy}}, \bibinfo {author} {\bibfnamefont {CW}~\bibnamefont {Morris}},
  \bibinfo {author} {\bibfnamefont {MF}~\bibnamefont {Wilkins}}, \bibinfo
  {author} {\bibfnamefont {GA}~\bibnamefont {Tarran}}, \ and\ \bibinfo {author}
  {\bibfnamefont {PH}~\bibnamefont {Burkill}},\ }\bibfield  {title} {\enquote
  {\bibinfo {title} {Neural network analysis of flow cytometric data for 40
  marine phytoplankton species},}\ }\href@noop {} {\bibfield  {journal}
  {\bibinfo  {journal} {Cytometry}\ }\textbf {\bibinfo {volume} {15}},\
  \bibinfo {pages} {283--293} (\bibinfo {year} {1994})}\BibitemShut {NoStop}%
\bibitem [{\citenamefont {Bradley}(1997)}]{bradley1997use}%
  \BibitemOpen
  \bibfield  {author} {\bibinfo {author} {\bibfnamefont {Andrew~P}\
  \bibnamefont {Bradley}},\ }\bibfield  {title} {\enquote {\bibinfo {title}
  {The use of the area under the roc curve in the evaluation of machine
  learning algorithms},}\ }\href@noop {} {\bibfield  {journal} {\bibinfo
  {journal} {Pattern recognition}\ }\textbf {\bibinfo {volume} {30}},\ \bibinfo
  {pages} {1145--1159} (\bibinfo {year} {1997})}\BibitemShut {NoStop}%
\bibitem [{\citenamefont {Powers}(2011)}]{powers2011evaluation}%
  \BibitemOpen
  \bibfield  {author} {\bibinfo {author} {\bibfnamefont {David~Martin}\
  \bibnamefont {Powers}},\ }\bibfield  {title} {\enquote {\bibinfo {title}
  {Evaluation: from precision, recall and f-measure to roc, informedness,
  markedness and correlation},}\ }\href@noop {} {\  (\bibinfo {year}
  {2011})}\BibitemShut {NoStop}%
\bibitem [{\citenamefont {Huang}\ and\ \citenamefont
  {Ling}(2005)}]{huang2005using}%
  \BibitemOpen
  \bibfield  {author} {\bibinfo {author} {\bibfnamefont {Jin}\ \bibnamefont
  {Huang}}\ and\ \bibinfo {author} {\bibfnamefont {Charles~X}\ \bibnamefont
  {Ling}},\ }\bibfield  {title} {\enquote {\bibinfo {title} {Using auc and
  accuracy in evaluating learning algorithms},}\ }\href@noop {} {\bibfield
  {journal} {\bibinfo  {journal} {Knowledge and Data Engineering, IEEE
  Transactions on}\ }\textbf {\bibinfo {volume} {17}},\ \bibinfo {pages}
  {299--310} (\bibinfo {year} {2005})}\BibitemShut {NoStop}%
\bibitem [{\citenamefont {LeCun}\ \emph {et~al.}(2015)\citenamefont {LeCun},
  ...
  }\bibfield  {title} {\enquote {\bibinfo {title} {Deep learning},}\
  }\href@noop {} {\bibfield  {journal} {\bibinfo  {journal} {Nature}\ }\textbf
  {\bibinfo {volume} {521}},\ \bibinfo {pages} {436--444} (\bibinfo {year}
  {2015})}\BibitemShut {NoStop}%
\bibitem [{\citenamefont {Schmidhuber}(2015)}]{schmidhuber2015deep}%
  \BibitemOpen
  \bibfield  {author} {\bibinfo {author} {\bibfnamefont {J{\"u}rgen}\
  \bibnamefont {Schmidhuber}},\ }\bibfield  {title} {\enquote {\bibinfo {title}
  {Deep learning in neural networks: An overview},}\ }\href@noop {} {\bibfield
  {journal} {\bibinfo  {journal} {Neural Networks}\ }\textbf {\bibinfo {volume}
  {61}},\ \bibinfo {pages} {85--117} (\bibinfo {year} {2015})}\BibitemShut
  {NoStop}%
\bibitem [{\citenamefont {Hanley}\ and\ \citenamefont
  {McNeil}(1982)}]{hanley1982meaning}%
  \BibitemOpen
  \bibfield  {author} {\bibinfo {author} {\bibfnamefont {James~A}\ \bibnamefont
  {Hanley}}\ and\ \bibinfo {author} {\bibfnamefont {Barbara~J}\ \bibnamefont
  {McNeil}},\ }\bibfield  {title} {\enquote {\bibinfo {title} {The meaning and
  use of the area under a receiver operating characteristic (roc) curve.}}\
  }\href@noop {} {\bibfield  {journal} {\bibinfo  {journal} {Radiology}\
  }\textbf {\bibinfo {volume} {143}},\ \bibinfo {pages} {29--36} (\bibinfo
  {year} {1982})}\BibitemShut {NoStop}%
\bibitem [{\citenamefont {Ling}\ \emph {et~al.}(2003)\citenamefont {Ling},
  \citenamefont {Huang},\ and\ \citenamefont {Zhang}}]{ling2003auc}%
  \BibitemOpen
  \bibfield  {author} {\bibinfo {author} {\bibfnamefont {Charles~X}\
  \bibnamefont {Ling}}, \bibinfo {author} {\bibfnamefont {Jin}\ \bibnamefont
  {Huang}}, \ and\ \bibinfo {author} {\bibfnamefont {Harry}\ \bibnamefont
  {Zhang}},\ }\bibfield  {title} {\enquote {\bibinfo {title} {Auc: a
  statistically consistent and more discriminating measure than accuracy},}\
  }in\ \href@noop {} {\emph {\bibinfo {booktitle} {IJCAI}}},\ Vol.~\bibinfo
  {volume} {3}\ (\bibinfo {year} {2003})\ pp.\ \bibinfo {pages}
  {519--524}\BibitemShut {NoStop}%
\bibitem [{\citenamefont {Cortes}\ and\ \citenamefont
  {Mohri}(2004)}]{cortes2004auc}%
  \BibitemOpen
  \bibfield  {author} {\bibinfo {author} {\bibfnamefont {Corinna}\ \bibnamefont
  {Cortes}}\ and\ \bibinfo {author} {\bibfnamefont {Mehryar}\ \bibnamefont
  {Mohri}},\ }\bibfield  {title} {\enquote {\bibinfo {title} {Auc optimization
  vs. error rate minimization},}\ }\href@noop {} {\bibfield  {journal}
  {\bibinfo  {journal} {Advances in neural information processing systems}\
  }\textbf {\bibinfo {volume} {16}},\ \bibinfo {pages} {313--320} (\bibinfo
  {year} {2004})}\BibitemShut {NoStop}%
\bibitem [{\citenamefont {Liu}\ and\ \citenamefont {Tan}(2008)}]{liu2008roc}%
  \BibitemOpen
  \bibfield  {author} {\bibinfo {author} {\bibfnamefont {Zhenqiu}\ \bibnamefont
  {Liu}}\ and\ \bibinfo {author} {\bibfnamefont {Ming}\ \bibnamefont {Tan}},\
  }\bibfield  {title} {\enquote {\bibinfo {title} {Roc-based utility function
  maximization for feature selection and classification with applications to
  high-dimensional protease data},}\ }\href@noop {} {\bibfield  {journal}
  {\bibinfo  {journal} {Biometrics}\ }\textbf {\bibinfo {volume} {64}},\
  \bibinfo {pages} {1155--1161} (\bibinfo {year} {2008})}\BibitemShut {NoStop}%
\bibitem [{\citenamefont {Verrelst}\ \emph {et~al.}(1998)\citenamefont
  {Verrelst}, \citenamefont {Moreau}, \citenamefont {Vandewalle},\ and\
  \citenamefont {Timmerman}}]{verrelst1998use}%
  \BibitemOpen
  \bibfield  {author} {\bibinfo {author} {\bibfnamefont {Herman}\ \bibnamefont
  {Verrelst}}, \bibinfo {author} {\bibfnamefont {Yves}\ \bibnamefont {Moreau}},
  \bibinfo {author} {\bibfnamefont {Joos}\ \bibnamefont {Vandewalle}}, \ and\
  \bibinfo {author} {\bibfnamefont {Dirk}\ \bibnamefont {Timmerman}},\
  }\bibfield  {title} {\enquote {\bibinfo {title} {Use of a multi-layer
  perceptron to predict malignancy in ovarian tumors},}\ }\href@noop {}
  {\bibfield  {journal} {\bibinfo  {journal} {Advances in Neural Information
  Processing Systems}\ ,\ \bibinfo {pages} {978--984}} (\bibinfo {year}
  {1998})}\BibitemShut {NoStop}%
\bibitem [{\citenamefont {Merchant}\ \emph {et~al.}(2012)\citenamefont
  {Merchant}, \citenamefont {Kropat}, \citenamefont {Liu}, \citenamefont
  {Shaw},\ and\ \citenamefont {Warakanont}}]{merchant2012tag}%
  \BibitemOpen
  \bibfield  {author} {\bibinfo {author} {\bibfnamefont {Sabeeha~S}\
  \bibnamefont {Merchant}}, \bibinfo {author} {\bibfnamefont {Janette}\
  \bibnamefont {Kropat}}, \bibinfo {author} {\bibfnamefont {Bensheng}\
  \bibnamefont {Liu}}, \bibinfo {author} {\bibfnamefont {Johnathan}\
  \bibnamefont {Shaw}}, \ and\ \bibinfo {author} {\bibfnamefont {Jaruswan}\
  \bibnamefont {Warakanont}},\ }\bibfield  {title} {\enquote {\bibinfo {title}
  {Tag, you’re it! chlamydomonas as a reference organism for understanding
  algal triacylglycerol accumulation},}\ }\href@noop {} {\bibfield  {journal}
  {\bibinfo  {journal} {Current opinion in biotechnology}\ }\textbf {\bibinfo
  {volume} {23}},\ \bibinfo {pages} {352--363} (\bibinfo {year}
  {2012})}\BibitemShut {NoStop}%
\bibitem [{\citenamefont {Zabawinski}\ \emph {et~al.}(2001)\citenamefont
  {Zabawinski}, \citenamefont {Van Den~Koornhuyse}, \citenamefont {D'Hulst},
  \citenamefont {Schlichting}, \citenamefont {Giersch}, \citenamefont {Delrue},
  \citenamefont {Lacroix}, \citenamefont {Preiss},\ and\ \citenamefont
  {Ball}}]{zabawinski2001starchless}%
  \BibitemOpen
  \bibfield  {author} {\bibinfo {author} {\bibfnamefont {Christophe}\
  \bibnamefont {Zabawinski}}, \bibinfo {author} {\bibfnamefont {Nathalie}\
  \bibnamefont {Van Den~Koornhuyse}}, \bibinfo {author} {\bibfnamefont
  {Christophe}\ \bibnamefont {D'Hulst}}, \bibinfo {author} {\bibfnamefont
  {Ralf}\ \bibnamefont {Schlichting}}, \bibinfo {author} {\bibfnamefont
  {Christoph}\ \bibnamefont {Giersch}}, \bibinfo {author} {\bibfnamefont
  {Brigitte}\ \bibnamefont {Delrue}}, \bibinfo {author} {\bibfnamefont
  {Jean-Marie}\ \bibnamefont {Lacroix}}, \bibinfo {author} {\bibfnamefont
  {Jack}\ \bibnamefont {Preiss}}, \ and\ \bibinfo {author} {\bibfnamefont
  {Steven}\ \bibnamefont {Ball}},\ }\bibfield  {title} {\enquote {\bibinfo
  {title} {Starchless mutants of chlamydomonas reinhardtii lack the small
  subunit of a heterotetrameric adp-glucose pyrophosphorylase},}\ }\href@noop
  {} {\bibfield  {journal} {\bibinfo  {journal} {Journal of Bacteriology}\
  }\textbf {\bibinfo {volume} {183}},\ \bibinfo {pages} {1069--1077} (\bibinfo
  {year} {2001})}\BibitemShut {NoStop}%
\bibitem [{\citenamefont {Work}\ \emph {et~al.}(2010)\citenamefont {Work},
  \citenamefont {Radakovits}, \citenamefont {Jinkerson}, \citenamefont
  {Meuser}, \citenamefont {Elliott}, \citenamefont {Vinyard}, \citenamefont
  {Laurens}, \citenamefont {Dismukes},\ and\ \citenamefont
  {Posewitz}}]{work2010increased}%
  \BibitemOpen
  \bibfield  {author} {\bibinfo {author} {\bibfnamefont {Victoria~H}\
  \bibnamefont {Work}}, \bibinfo {author} {\bibfnamefont {Randor}\ \bibnamefont
  {Radakovits}}, \bibinfo {author} {\bibfnamefont {Robert~E}\ \bibnamefont
  {Jinkerson}}, \bibinfo {author} {\bibfnamefont {Jonathan~E}\ \bibnamefont
  {Meuser}}, \bibinfo {author} {\bibfnamefont {Lee~G}\ \bibnamefont {Elliott}},
  \bibinfo {author} {\bibfnamefont {David~J}\ \bibnamefont {Vinyard}}, \bibinfo
  {author} {\bibfnamefont {Lieve~ML}\ \bibnamefont {Laurens}}, \bibinfo
  {author} {\bibfnamefont {G~Charles}\ \bibnamefont {Dismukes}}, \ and\
  \bibinfo {author} {\bibfnamefont {Matthew~C}\ \bibnamefont {Posewitz}},\
  }\bibfield  {title} {\enquote {\bibinfo {title} {Increased lipid accumulation
  in the chlamydomonas reinhardtii sta7-10 starchless isoamylase mutant and
  increased carbohydrate synthesis in complemented strains},}\ }\href@noop {}
  {\bibfield  {journal} {\bibinfo  {journal} {Eukaryotic Cell}\ }\textbf
  {\bibinfo {volume} {9}},\ \bibinfo {pages} {1251--1261} (\bibinfo {year}
  {2010})}\BibitemShut {NoStop}%
\bibitem [{\citenamefont {Li}\ \emph {et~al.}(2010)\citenamefont {Li},
  \citenamefont {Han}, \citenamefont {Hu}, \citenamefont {Dauvillee},
  \citenamefont {Sommerfeld}, \citenamefont {Ball},\ and\ \citenamefont
  {Hu}}]{li2010chlamydomonas}%
  \BibitemOpen
  \bibfield  {author} {\bibinfo {author} {\bibfnamefont {Yantao}\ \bibnamefont
  {Li}}, \bibinfo {author} {\bibfnamefont {Danxiang}\ \bibnamefont {Han}},
  \bibinfo {author} {\bibfnamefont {Guongrong}\ \bibnamefont {Hu}}, \bibinfo
  {author} {\bibfnamefont {David}\ \bibnamefont {Dauvillee}}, \bibinfo {author}
  {\bibfnamefont {Milton}\ \bibnamefont {Sommerfeld}}, \bibinfo {author}
  {\bibfnamefont {Steven}\ \bibnamefont {Ball}}, \ and\ \bibinfo {author}
  {\bibfnamefont {Qiang}\ \bibnamefont {Hu}},\ }\bibfield  {title} {\enquote
  {\bibinfo {title} {Chlamydomonas starchless mutant defective in adp-glucose
  pyrophosphorylase hyper-accumulates triacylglycerol},}\ }\href@noop {}
  {\bibfield  {journal} {\bibinfo  {journal} {Metabolic engineering}\ }\textbf
  {\bibinfo {volume} {12}},\ \bibinfo {pages} {387--391} (\bibinfo {year}
  {2010})}\BibitemShut {NoStop}%
\bibitem [{\citenamefont {Goodenough}\ \emph {et~al.}(2014)\citenamefont
  {Goodenough}, \citenamefont {Blaby}, \citenamefont {Casero}, \citenamefont
  {Gallaher}, \citenamefont {Goodson}, \citenamefont {Johnson}, \citenamefont
  {Lee}, \citenamefont {Merchant}, \citenamefont {Pellegrini}, \citenamefont
  {Roth} \emph {et~al.}}]{goodenough2014path}%
  \BibitemOpen
  \bibfield  {author} {\bibinfo {author} {\bibfnamefont {Ursula}\ \bibnamefont
  {Goodenough}}, \bibinfo {author} {\bibfnamefont {Ian}\ \bibnamefont {Blaby}},
  \bibinfo {author} {\bibfnamefont {David}\ \bibnamefont {Casero}}, \bibinfo
  {author} {\bibfnamefont {Sean~D}\ \bibnamefont {Gallaher}}, \bibinfo {author}
  {\bibfnamefont {Carrie}\ \bibnamefont {Goodson}}, \bibinfo {author}
  {\bibfnamefont {Shannon}\ \bibnamefont {Johnson}}, \bibinfo {author}
  {\bibfnamefont {Jae-Hyeok}\ \bibnamefont {Lee}}, \bibinfo {author}
  {\bibfnamefont {Sabeeha~S}\ \bibnamefont {Merchant}}, \bibinfo {author}
  {\bibfnamefont {Matteo}\ \bibnamefont {Pellegrini}}, \bibinfo {author}
  {\bibfnamefont {Robyn}\ \bibnamefont {Roth}},  \emph {et~al.},\ }\bibfield
  {title} {\enquote {\bibinfo {title} {The path to triacylglyceride obesity in
  the sta6 strain of chlamydomonas reinhardtii},}\ }\href@noop {} {\bibfield
  {journal} {\bibinfo  {journal} {Eukaryotic cell}\ ,\ \bibinfo {pages}
  {EC--00013}} (\bibinfo {year} {2014})}\BibitemShut {NoStop}%
...
\bibitem [{\citenamefont {Buckley}\ \emph {et~al.}(2013)\citenamefont
  {Buckley}, \citenamefont {Madni},\ and\ \citenamefont
  {Jalali}}]{buckley2013coherent}%
  \BibitemOpen
  \bibfield  {author} {\bibinfo {author} {\bibfnamefont {Brandon~W}\
  \bibnamefont {Buckley}}, \bibinfo {author} {\bibfnamefont {Asad~M}\
  \bibnamefont {Madni}}, \ and\ \bibinfo {author} {\bibfnamefont {Bahram}\
  \bibnamefont {Jalali}},\ }\bibfield  {title} {\enquote {\bibinfo {title}
  {Coherent time-stretch transformation for real-time capture of wideband
  signals},}\ }\href@noop {} {\bibfield  {journal} {\bibinfo  {journal} {Optics
  express}\ }\textbf {\bibinfo {volume} {21}},\ \bibinfo {pages} {21618--21627}
  (\bibinfo {year} {2013})}\BibitemShut {NoStop}%
\bibitem [{\citenamefont {DeVore}\ \emph {et~al.}(2014)\citenamefont {DeVore},
  \citenamefont {Buckley}, \citenamefont {Asghari}, \citenamefont {Solli},\
  and\ \citenamefont {Jalali}}]{devore2014coherent}%
  \BibitemOpen
  \bibfield  {author} {\bibinfo {author} {\bibfnamefont {Peter~TS}\
  \bibnamefont {DeVore}}, \bibinfo {author} {\bibfnamefont {Brandon~W}\
  \bibnamefont {Buckley}}, \bibinfo {author} {\bibfnamefont {Mohammad~H}\
  \bibnamefont {Asghari}}, \bibinfo {author} {\bibfnamefont {Daniel~R}\
  \bibnamefont {Solli}}, \ and\ \bibinfo {author} {\bibfnamefont {Bahram}\
  \bibnamefont {Jalali}},\ }\bibfield  {title} {\enquote {\bibinfo {title}
  {Coherent time-stretch transform for near-field spectroscopy},}\ }\href@noop
  {} {\bibfield  {journal} {\bibinfo  {journal} {IEEE Photonics Journal}\
  }\textbf {\bibinfo {volume} {6}},\ \bibinfo {pages} {3300107} (\bibinfo
  {year} {2014})}\BibitemShut {NoStop}%
\bibitem [{\citenamefont {Kamentsky}\ \emph {et~al.}(2011)\citenamefont
  {Kamentsky}, \citenamefont {Jones}, \citenamefont {Fraser}, \citenamefont
  {Bray}, \citenamefont {Logan}, \citenamefont {Madden}, \citenamefont {Ljosa},
  \citenamefont {Rueden}, \citenamefont {Eliceiri},\ and\ \citenamefont
  {Carpenter}}]{kamentsky2011improved}%
  \BibitemOpen
  \bibfield  {author} {\bibinfo {author} {\bibfnamefont {Lee}\ \bibnamefont
  {Kamentsky}}, \bibinfo {author} {\bibfnamefont {Thouis~R}\ \bibnamefont
  {Jones}}, \bibinfo {author} {\bibfnamefont {Adam}\ \bibnamefont {Fraser}},
  \bibinfo {author} {\bibfnamefont {Mark-Anthony}\ \bibnamefont {Bray}},
  \bibinfo {author} {\bibfnamefont {David~J}\ \bibnamefont {Logan}}, \bibinfo
  {author} {\bibfnamefont {Katherine~L}\ \bibnamefont {Madden}}, \bibinfo
  {author} {\bibfnamefont {Vebjorn}\ \bibnamefont {Ljosa}}, \bibinfo {author}
  {\bibfnamefont {Curtis}\ \bibnamefont {Rueden}}, \bibinfo {author}
  {\bibfnamefont {Kevin~W}\ \bibnamefont {Eliceiri}}, \ and\ \bibinfo {author}
  {\bibfnamefont {Anne~E}\ \bibnamefont {Carpenter}},\ }\bibfield  {title}
  {\enquote {\bibinfo {title} {Improved structure, function and compatibility
  for cellprofiler: modular high-throughput image analysis software},}\
  }\href@noop {} {\bibfield  {journal} {\bibinfo  {journal} {Bioinformatics}\
  }\textbf {\bibinfo {volume} {27}},\ \bibinfo {pages} {1179--1180} (\bibinfo
