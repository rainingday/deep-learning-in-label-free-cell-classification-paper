...
&\quad+ 2k(\lambda)L_0] \rbrace + \sqrt{1-r^2} E_i(t_p,\omega_{LO})\exp(i\omega_{LO} t + 2k(\lambda)L_0) \\
...
Define $r^\prime=\frac{r\alpha_s}{\sqrt{1-r^2+r^2\alpha_s^2}}$, the ratio of amplitude change caused by interference to that of envelop change caused by cell absorption:
\begin{equation}
\begin{split}
\beta = \frac{I_intf}{I_env} &= \frac{2 \alpha_c cos[i\Delta\varphi(x,t)]}{\frac{\sqrt{1-r^2}}{r\alpha_s} + \frac{\alpha_c^2(x,t) \alpha_s r}{\sqrt{1-r^2}}} \\
